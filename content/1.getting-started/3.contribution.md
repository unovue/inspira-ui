...
If you find a bug, please open an [issue](https://github.com/radix-vue/inspira-ui/issues){:target="\_blank"} and include:
...
We welcome suggestions for new features or improvements. Please open an [issue](https://github.com/radix-vue/inspira-ui/issues){:target="\_blank"} and include:
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/radix-vue/inspira-ui/blob/main/LICENSE){:target="\_blank"}.
