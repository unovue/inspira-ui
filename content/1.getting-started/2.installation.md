...
```bash [npm]
npm install -D @inspira-ui/plugins cslx tailwind-merge tailwindcss-animate
```

```bash [pnpm]
pnpm install -D @inspira-ui/plugins cslx tailwind-merge tailwindcss-animate
```

```bash [bun]
bun add -d @inspira-ui/plugins cslx tailwind-merge tailwindcss-animate
```

```bash [yarn]
yarn add --dev @inspira-ui/plugins cslx tailwind-merge tailwindcss-animate
```
