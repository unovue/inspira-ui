...
```bash [npm]
npm install -D @inspira-ui/plugins clsx tailwind-merge class-variance-authority
```

```bash [pnpm]
pnpm install -D @inspira-ui/plugins clsx tailwind-merge class-variance-authority
```

```bash [bun]
bun add -d @inspira-ui/plugins clsx tailwind-merge class-variance-authority
```

```bash [yarn]
yarn add --dev @inspira-ui/plugins clsx tailwind-merge class-variance-authority
```
