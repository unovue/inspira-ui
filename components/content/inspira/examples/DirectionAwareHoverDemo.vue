  ...
  <div class="container mx-auto p-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <DirectionAwareHover
        ...
        class-name="border-4 border-primary"
        image-class-name="scale-100 hover:scale-110"
        children-class-name="bg-black bg-opacity-50 p-4 rounded"
      >
      ...
      <DirectionAwareHover
        ...
        class-name="shadow-xl rounded-xl overflow-hidden"
      >
