...
const childClass = (index) => ({
  'opacity-100 blur-none': isRevealed.value[index],
  [`opacity-0 blur-[${props.blur}]`]: !isRevealed.value[index],
});
...
.fade-blur-leave-active {
  transition: opacity var(--duration) ease-in-out, filter var(--duration) ease-in-out;
}
